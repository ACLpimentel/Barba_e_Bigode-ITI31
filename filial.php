...
<html>
    ...
    <body>
        ...
        <form name="formServico" action="filial_inserir.php" method="post">
            <div id="body">
                ...
                <ol>
                    ...
                    <li><input type="text" name="txtLocalizacao" placeholder="Localização" class="input"/>
                    </li>

                    <li><input type="text" name="txtResponsavel" placeholder="nome do Responsavel" class="input"/>
                    </li>
